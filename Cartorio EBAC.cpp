...
#include <stdlib.h> //biblioteca de alocção de espaço em memoria
#include <locale.h> // biblioteca de alocação de texto por região
#include <string.h> // biblioteca responsavel por cuidar da sting

int registro() // função responsavel por cadastro
{
	// inicio de criaçao de variaveis/string
	char arquivo[40];
	char cpf[40];
	char nome[40];
	char sobrenome[40];
	...
	file = fopen(arquivo, "w"); // abre o arquivo "w" é para escrever
